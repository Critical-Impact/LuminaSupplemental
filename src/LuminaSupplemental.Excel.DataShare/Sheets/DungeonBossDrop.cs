...
public struct DungeonBossDrop : ISupplementalRow<Tuple<uint, uint, uint, uint>>, ICsv
{
    private Tuple<uint, uint, uint, uint> data;
    
    public uint ContentFinderConditionId => this.data.Item1;
    
    public uint FightNo => this.data.Item2;
    
    public uint ItemId => this.data.Item3;
    
    public uint Quantity => this.data.Item4;
    ...
    public DungeonBossDrop(Tuple<uint, uint, uint, uint> data, int rowId)
    {
        this.data = data;
        this.RowId = rowId;
    }
