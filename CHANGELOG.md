...
### Changed
- Made coffer auto-matching consider item level if applicable
- Removed a misplaced item from the manual data list
...
### Changed
- General data update
- More festival names thanks to @Minmoose
